<?php
include('dash_login.php'); // Includes Login Script
?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <form action="" method="post">
                    <div class="panel panel-body login-form">
                        ...
                        <div class="form-group">
                            <input type="submit" name="submit" class="btn bg-pink-400 btn-block"></input>
                        </div>

                        <div class="text-danger-600 text-center"><b><?php echo $error ?></b></div>
                ...
                <div class="footer text-muted text-center">
                    &copy; 2015. <a href="#">Limitless Web App Kit</a> by <a href="h" target="_blank">Eugene Kopyov</a>
                </div>
                <!-- /footer -->
...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/material/login_advanced.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Mar 2018 08:05:46 GMT -->
</html>
